...
pdf.body(
    ...
    '支持 Google、百度、Bing、搜狗、360 搜索、知乎、微博、B站、GitHub、DuckDuckGo、X、YouTube 等 13 种引擎\n'
...
pdf.body(
    ...
    '• 显示选项：日期、星期、农历、天气、待办清单、最近访问的显示开关\n'
...
# ===== 8b. 待办清单 =====
pdf.body(
    '呲啦起始页内置待办清单功能，可快速记录日常待办事项：\n\n'
    '• 在设置面板中开启或关闭待办清单显示\n'
    '• 点击待办输入框添加新待办\n'
    '• 点击待办事项可标记为已完成\n'
    '• 支持删除已完成或不需要的待办\n\n'
    '待办清单数据自动保存在本地，刷新页面不丢失。'
)
...
pdf.body(
    'Q：免费版够用吗？\n'
    'A：完全够用。免费版包含 6 种搜索引擎、3 个导航分组、全部壁纸预设和天气功能。'
    '日常使用场景均能覆盖。\n\n'
    'Q：会收集我的数据吗？\n'
