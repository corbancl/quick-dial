...
const zh: Dict = {
  ...
  'footer.about': '关于我们','footer.privacy': '隐私政策','footer.copyright': '版权声明','footer.contact': '联系方式','footer.domain': '呲啦起始页','footer.psbNumber': '鲁公网安备 待提交','footer.psbPending': '网安备案号申请中',
...
const en: Dict = {
  ...
  'footer.about': 'About','footer.privacy': 'Privacy','footer.copyright': 'Copyright','footer.contact': 'Contact','footer.domain': 'Quick Dial','footer.psbNumber': 'PSB Filing Pending','footer.psbPending': 'PSB filing in progress',
