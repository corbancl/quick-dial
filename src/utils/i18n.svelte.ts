...
const zh: Dict = {
  ...
  'stats.title': '访问统计','stats.total': '总点击','stats.sites': '站点数','stats.ranking': '点击排行','stats.empty': '暂无访问数据','stats.clear': '清除数据','stats.export': '导出 CSV','stats.today': '今日','stats.weekly': '近 7 天趋势','stats.trend': '近 30 天趋势','stats.byCategory': '热门分类','stats.byHour': '时段分布','stats.categories': '分类数','stats.uncategorized': '未分组',
...
const en: Dict = {
  ...
  'stats.title': 'Statistics','stats.total': 'Total Clicks','stats.sites': 'Sites','stats.ranking': 'Top Sites','stats.empty': 'No data','stats.clear': 'Clear','stats.export': 'Export CSV','stats.today': 'Today','stats.weekly': 'Last 7 Days','stats.trend': 'Last 30 Days','stats.byCategory': 'Top Categories','stats.byHour': 'Hourly Distribution','stats.categories': 'Categories','stats.uncategorized': 'Uncategorized',
